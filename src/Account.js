        ...
        <div className="account">
            ...
            <div className="account__body">
                <div className="account__body__left">
                    ...
                    <div className="account__body__left__info">
                        <div>
                            <input type="checkbox"/><small>I hereby confirm that i am above 18 years old</small>
                        </div>
                        <button>Verify OTP</button>
                        <p>By creating this account you agree to our <a href="/">Privacy Policy</a> and Terms of use</p>
                    </div>
                </div>
